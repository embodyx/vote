...
class OpenVLAForActionPrediction(PrismaticForConditionalGeneration):
    ...
    def _prepare_labels_for_action_prediction(self, labels, input_ids):
        ...
        # labels不重要只是要一个mask. 为什么需要这个函数? 确保 action 预测任务的标签（labels）符合模型的输入长度，并正确地处理序列终止
    ...
    def _regression_or_discrete_prediction(
        ...
        all_actions_mask : Optional[torch.BoolTensor], # 为了提取前面的embedding用. 去掉action . 
        ...
        **kwargs,
        ...
        # refer: https://discuss.huggingface.co/t/get-each-generated-token-last-layer-hidden-state/145921
